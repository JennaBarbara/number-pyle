...
export default function HowToDialog({gameModeTitle, gameModeKey}:HowToDialogProps) {
      ...
      <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
        <div className="fixed inset-0 outline-0 flex w-screen items-center justify-center p-4 bg-stone-700/25">
          <DialogPanel className="max-w-lg rounded-md space-y-4 bg-white p-12">
            <DialogTitle className="font-bold">How To Play {gameModeTitle}</DialogTitle>
            {gameModeKey === 'numberPyle' ? (
